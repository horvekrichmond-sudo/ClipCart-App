...
import { MoreVertical, Timer, CheckCircle2, ExternalLink } from 'lucide-react';
...
const VideoCard: React.FC<VideoCardProps> = ({ ad, onClick }) => {
  ...
  return (
    /* 
       Elastic Container: 
       Maintains high-fidelity look without premature action buttons.
    */
    <div className="bg-transparent overflow-hidden mb-2 group relative flex flex-col h-full rounded-b-2xl md:rounded-none w-full min-w-0 transition-all duration-300">
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center">
          <div className="bg-black/40 backdrop-blur-md p-4 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 scale-75 group-hover:scale-100">
      ...
      {/* Meta Content Area */}
      <div className="px-1 pt-4 pb-6 flex gap-4">
